...
packages:
  ...
  /@material-tailwind/react@2.1.5(react-dom@18.2.0)(react@18.2.0):
    resolution: {integrity: sha512-Jzy+Lmunn0BhI+jQKr4K3PtsbjNrLxLIHQPXFIljjZkj4GTLiz1rbMbfratWnnEcW/F1p4HIKDtI9bMvH0oGow==}
    peerDependencies:
      react: ^16 || ^17 || ^18
      react-dom: ^16 || ^17 || ^18
    dependencies:
