...
declare namespace H.map {
  ...
  class SpatialStyle {
     ...
     */
    lineDashImage ? : HTMLCanvasElement | HTMLImageElement ;
    /**
...
declare namespace H.map.SpatialStyle {
  type DashImage = HTMLImageElement &{clutzEnumBrand: never} ;
  let DashImage : {
    ARROW : DashImage ,
    CIRCLE : DashImage ,
  };
  ...
  type Options = { fillColor ? : string , lineCap ? : string , lineDash ? : number [] , lineDashImage ? : HTMLImageElement | HTMLCanvasElement , lineDashOffset ? : number , lineHeadCap ? : string , lineJoin ? : string , lineTailCap ? : string , lineWidth ? : number , miterLimit ? : number , strokeColor ? : string } ;
}
declare namespace H.map {
  /**
...
declare namespace H.map {
   ...
   * is rendered. It contains the information regarding the view port size and
...
declare namespace H.service {
  ...
  class Platform {
     ...
     * - [HERE Vector Tile API v2](https://www.here.com/docs/category/vector-tile-api)
